...
test("bot infrastructure retains identity while rated matchmaking rejects heuristic fallback", () => {
  ...
  assert.doesNotMatch(matchmaking, /INSERT INTO game_bots/);
  assert.doesNotMatch(matchmaking, /botDifficultyForRating|unrated-after-wait/);
