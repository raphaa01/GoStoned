...
test("English and German distinguish rated account games and disclose leaderboard eligibility", () => {
  ...
  assert.match(en.leaderboard.description, /global account rating/);
  assert.match(en.leaderboard.description, /established human accounts/);
  assert.match(de.leaderboard.description, /globale Kontowertung/);
  assert.match(de.leaderboard.description, /menschliche Konten/);
  assert.match(en.leaderboard.ratingMethod, /Glicko-2/);
  assert.match(en.leaderboard.ratingMethod, /first 10 rated games/);
  assert.match(en.leaderboard.ratingMethod, /uncertainty/);
  assert.match(de.leaderboard.ratingMethod, /Glicko-2/);
  assert.match(de.leaderboard.ratingMethod, /ersten 10 gewerteten Partien/);
  assert.match(de.leaderboard.ratingMethod, /Unsicherheit/);
