...
export const RATE_LIMIT_POLICIES = {
  ...
  profileMutation: { scope: "profile-mutation", limit: 12, ipLimit: 120, windowMinutes: 1 },
  friendsRead: { scope: "friends-read", limit: 120, ipLimit: 1_200, windowMinutes: 1 },
  friendsMutation: { scope: "friends-mutation", limit: 20, ipLimit: 200, windowMinutes: 1 },
  friendSearch: { scope: "friend-search", limit: 30, ipLimit: 300, windowMinutes: 1 },
  friendMessageSend: { scope: "friend-message-send", limit: 30, ipLimit: 300, windowMinutes: 1 },
